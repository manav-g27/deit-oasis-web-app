...
MODEL_URL = (
    "https://github.com/manav-g27/deit-oasis-web-app/releases/download/v1.0/alz_vit.pt"
)
...
def download_model():
    """Download the trained model if it is not already present."""
    ...
    print("Downloading pretrained model (~330 MB)...")
...
# =============== MODEL BUILD ===============
def build_model():
    """Create the DeiT model architecture."""
...
demo = gr.Interface(
    ...
    title="🧠 Alzheimer's Disease Detection using Vision Transformer (DeiT)",
    description = """
### Deep Learning Based Alzheimer's Disease Detection

This web application demonstrates an end-to-end deep learning pipeline for Alzheimer's disease stage classification from MRI images using a pretrained **DeiT Vision Transformer**.
...
| 🟡 Very Mild Dementia | Early cognitive changes |
| 🟠 Mild Dementia | Mild Alzheimer's |
| 🔴 Moderate Dementia | Advanced Alzheimer's |

> ⚠️ **Research Use Only** • Not intended for clinical diagnosis.
"""
)
