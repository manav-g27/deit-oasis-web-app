...
# =============== USER CONFIG ===============
MODEL_PATH = "/Users/manavgupta/Desktop/DEIT_OASIS_WEB_APP/models/alz_vit.pt"
...
demo = gr.Interface(
    ...
    outputs=[
        ...
        gr.Label(num_top_classes=len(CLASS_NAMES) if CLASS_NAMES else 5, label="Class probabilities"),
    ],
    title="Alzheimer's Image Classification (DEIT)",
    description="Upload an image to classify using a Swin Transformer model from alz_vit.pt"
)
